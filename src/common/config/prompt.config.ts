...
const agentTools = [
			...
			parameters: {
				...
				properties: {
					...
					attachments: {
						...
						description:
							'(Optional) List of attachments to show to user, can be file paths or URLs',
					},
				},
				required: ['text'],
			},
			...
			parameters: {
				...
				properties: {
					url: {
						type: 'string',
						description:
							'Complete URL to visit after restart. Must include protocol prefix.',
					},
				},
				required: ['url'],
			},
			...
			parameters: {
				...
				properties: {
					index: {
						type: 'integer',
						description:
							'(Optional) Index number of the element to overwrite text',
					},
					coordinate_x: {
						type: 'number',
						description:
							'(Optional) X coordinate of the element to overwrite text',
					},
					coordinate_y: {
						type: 'number',
						description:
							'(Optional) Y coordinate of the element to overwrite text',
					},
					text: {
						type: 'string',
			...
			parameters: {
				...
				properties: {
					key: {
						type: 'string',
						description:
							'Key name to simulate (e.g., Enter, Tab, ArrowUp), supports key combinations (e.g., Control+Enter).',
					},
				},
				required: ['key'],
			},
			...
			parameters: {
				...
				properties: {
					to_top: {
						type: 'boolean',
						description:
							'(Optional) Whether to scroll directly to page top instead of one viewport up.',
					},
				},
			},
		},
			...
			parameters: {
				...
				properties: {
					to_bottom: {
						type: 'boolean',
						description:
							'(Optional) Whether to scroll directly to page bottom instead of one viewport down.',
					},
				},
			},
		},
			...
			parameters: {
				...
				properties: {
					javascript: {
						type: 'string',
						description:
							'JavaScript code to execute. Note that the runtime environment is browser console.',
					},
				},
				required: ['javascript'],
			},
			...
			parameters: {
				...
				properties: {
					query: {
						type: 'string',
						description:
							'Search query in Google search style, using 3-5 keywords.',
					},
					date_range: {
						type: 'string',
						enum: [
	...
	},
	{
		...
		function: {
			...
			description:
				'Deploy website or application to public production environment. Use when deploying or updating static websites or applications.',
			parameters: {
				type: 'object',
				properties: {
					type: {
