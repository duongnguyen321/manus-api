...
export class AnalyticsController {
  ...
  async getCurrentUserAnalytics(
    ...
    return this.analyticsService.getUserAnalytics(user.id, timeRange);
  }
  ...
  async getSystemMetrics(@Query('limit') limit: number = 100) {
    return this.analyticsService.getSystemMetrics(limit);
  }
  ...
  async generateReport(
    ...
    return this.analyticsService.generateReport(type, reportDate);
  }
}