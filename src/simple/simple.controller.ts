...
export class SimpleController {
  ...
  @ApiOperation({ 
    ...
    description: 'Create a new session for streamlined AI interaction. Session automatically manages Docker containers and browser contexts.'
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Send a message to AI and get intelligent response with automatic tool usage. AI can execute code, browse web, manage files, and more based on your request.'
  })
  @ApiBody({ 
    type: SimpleChatDto,
    examples: {
      ...
      codeExecution: {
        ...
        value: {
          message: 'Write a Python script to calculate fibonacci numbers and run it',
          sessionId: 'simple_1234567890_abc123'
        }
      },
      webBrowsing: {
        ...
        value: {
          message: 'Go to https://news.ycombinator.com and tell me the top 3 stories',
          sessionId: 'simple_1234567890_abc123'
        }
      },
      dataAnalysis: {
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve session information including message history and active resources'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Delete session and automatically cleanup all associated Docker containers and browser contexts'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Check if the simple API is running and ready to accept requests'
  })
  @ApiResponse({ 
    status: 200, 
